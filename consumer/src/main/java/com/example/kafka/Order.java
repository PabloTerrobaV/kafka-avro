...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9138538591673746389L;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: payment_method = (com.example.kafka.PaymentMethod.PaymentMethod)value$; break;
    case 7: order_status = (com.example.kafka.OrderStatus.OrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
    ...
    private Builder(com.example.kafka.Order.Builder other) {
      ...
      if (isValidValue(fields()[7], other.order_status)) {
        this.order_status = data().deepCopy(fields()[7].schema(), other.order_status);
    ...
    public Order build() {
      try {
        ...
        record.payment_method = fieldSetFlags()[6] ? this.payment_method : (com.example.kafka.PaymentMethod.PaymentMethod) defaultValue(fields()[6]);
        record.order_status = fieldSetFlags()[7] ? this.order_status : (com.example.kafka.OrderStatus.OrderStatus) defaultValue(fields()[7]);
        return record;
